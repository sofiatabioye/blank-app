...
names = ["Qowiyyah Oguntola"]
usernames = ["qowiyyah"]
passwords = ["password123"]

credentials = {"usernames": {username: {"name": name, "password": password} for name, username, password in zip(names, usernames, passwords)}}
authenticator = Authenticate(credentials, "app_home", "auth", cookie_expiry_days=30)
